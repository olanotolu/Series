...
export default function ProfileCard({
  ...
  return (
    ...
    >
      <h1 className="profile-name-large">{name}</h1>
      ...
      <div className="bio-section-large">
        <div className="bio-label">BIO</div>
        <div className="bio-text-large">{bio}</div>
      </div>
      
      {socialLinks && (socialLinks.linkedin || socialLinks.instagram) && (
